...
- [ ] Проверить: все ли дети якорей 17–20 имеют детей; найти «висячие»
      понятия без видов и без связей (список weak из `define()`).
- [ ] Выверить верхние 3 уровня: нет ли пропусков (напр. «явление»,
      «событие», «состояние» как сестринские к «действию»?).

### Этап 1 — Вещества и материалы (~60 понятий)
...
### Этап 4 — Природные объекты и явления (~40 понятий)
...
### Этап 5 — Свойства: закрыть шкалы (~60 понятий)
...
### Этап 6 — Действия и процессы (~80 понятий)
