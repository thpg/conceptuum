...
- **Этап:** 4 (природные объекты) — **завершён** ✓
- **Последнее действие:** Этап 4: +74 понятия, +39 связей; resolve_all для омонимов (2026-08-28)
- **Следующее действие:** Этап 5 — свойства: закрыть шкалы (~60 понятий)

## Снимок базы (на 2026-08-28, после этапа 1)

```
concepts: 1617 (бытовой: 735, IT: 882)
edges:    2059
paths:    7490
```
