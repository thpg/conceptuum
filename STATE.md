...
- **Последнее действие:** добиты термины. IT: 881 русских (файл, БД, ЯП…;
...
- **Следующее действие:** `processed` уровни 0–3 (1 род/виды, 2 свойства,
  3 параллельные); продолжить rank-список с ~1100.

## Снимок базы (на 2026-08-31, после fill_next)

```
concepts: 4557 (бытовой: 3298, IT: 882, юридический: 159, логика: 218)
edges:    6790
paths:    19927
processed: 0:2681  1:1212  2:310  3:354
kod 15:   19   kod 20: 366   15/20–27 у 13.2% понятий
```
