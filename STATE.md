...
## Снимок базы (на 2026-08-28, после миграции кодов 2X)

```
concepts: 2305 (бытовой: 1266, IT: 882, юридический: 157)
edges:    3833 (степени 21/23/25/27 -> 20+strength; 80-83 -> 21/22/23/27;
          новые коды 24 content / 25 application / 26 user)
paths:    10452
```
