...
## Снимок базы (на 2026-08-28, после чистки наследуемых атрибутов)

```
concepts: 2339 (бытовой: 1300, IT: 882, юридический: 157)
edges:    3889 (правило наследования: точные дубли рода удалены (42),
          специализации вида восстановлены (57); validate() предупреждает)
paths:    10612
```
